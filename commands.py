...
print('Top article:', Post.objects.filter(type='a').order_by('rating').values('created', 'author__user__username', 'rating', 'title').last())
top_post = Post.objects.filter(type='a').order_by('rating').last()
